...
public class GlutenFreeMeal extends AppCompatActivity {

    @BindView(R.id.glutenFreeListView) ListView mGlutenFreeListView;
    ...
    int[]  mMealsImages = {R.drawable.healthykids,R.drawable.looseweight,R.drawable.glutefree,R.drawable.highfibre,R.drawable.lowcholestrarol,};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gluten_free_meal);
