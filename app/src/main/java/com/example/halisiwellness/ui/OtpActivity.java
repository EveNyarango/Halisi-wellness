...
public class OtpActivity extends AppCompatActivity {
    ...
    @BindView(R.id.idEdtPhoneNumber) EditText edtPhone;
    @BindView(R.id.idEdtOtp) EditText edtOTP;
    @BindView(R.id.idBtnVerify) Button verifyOTPBtn;
    @BindView(R.id.idBtnGetOtp) Button mgenerateOTPBtn;
...
//    private Button verifyOTPBtn, mgenerateOTPBtn;
...
//        mgenerateOTPBtn = findViewById(R.id.idBtnGetOtp);

        // setting onclick listner for generate OTP button.
        mgenerateOTPBtn.setOnClickListener(new View.OnClickListener() {
            @Override
