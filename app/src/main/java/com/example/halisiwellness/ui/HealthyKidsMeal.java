...
public class HealthyKidsMeal extends AppCompatActivity {
    ...
    @BindView(R.id.healthyKidsListView) ListView mHealthyKidsListView;
    ...
    int[]  mMealsImages = {R.drawable.lowcholestrarol,R.drawable.highfibre,R.drawable.pregnancy,R.drawable.healthykids,R.drawable.looseweight,};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_healthy_kids_meal);
        ButterKnife.bind(this);


        MealsPlanAdapter mealsPlanAdapter = new MealsPlanAdapter(this, mMealsName,mMealsDescription,mMealsImages,mMealsDays);
        mHealthyKidsListView.setAdapter(mealsPlanAdapter);
    }
}