...
public class LooseWeight extends AppCompatActivity {
    ...
    @BindView(R.id.looseWeightListView)
    ListView mLooseWeightListView;
    ...
    int[]  mMealsImages = {R.drawable.looseweight,R.drawable.highfibre,R.drawable.glutefree,R.drawable.looseweight,R.drawable.healthykids,};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLooseWeightListView.setAdapter(mealsPlanAdapter);
    }
}