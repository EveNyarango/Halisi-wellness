...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatMessageAdapter(Context context, List<ChatMessage> data) {
        super(context, R.layout.chat_bot_user, data);
    }
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewType == MY_MESSAGE) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.chat_bot_user, parent, false);
            TextView textView = (TextView) convertView.findViewById(R.id.text);
            textView.setText(getItem(position).getContent());
        } else if (viewType == OTHER_MESSAGE) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.chat_bot_messager, parent, false);
            TextView textView = (TextView) convertView.findViewById(R.id.text);
            textView.setText(getItem(position).getContent());
